...
{#if showSearchBar}
	<div class="bg-neutral-100 opacity-60 w-full h-screen absolute z-10" transition:fade={{ duration: 300 }}></div>
	<div 
...
{#if (!dataState.hasInitialData || dataState.fetchingData) && !showSearchBar}
	...
	transition:fade={{duration: 300}}>
		...
		<div class="animate-pulse absolute -translate-y-16 flex items-center justify-center w-full h-screen rounded-lg bg-gray-50 dark:bg-gray-800">
			<div role="status">
